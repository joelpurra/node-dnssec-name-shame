...
var getdns = require("getdns"),
    ...
    getUnverifiedRecordsOfType = function(result, recordType) {
        var repliesTree = getReplyTreeListOrDie(result),
    ...
    getFirstUnverifiedRecordOfType = function(result, recordType) {
        var records = getUnverifiedRecordsOfType(result, recordType);
    ...
    hasUnverifiedRecordOfType = function(result, recordType) {
        var record = getFirstUnverifiedRecordOfType(result, recordType);
    ...
    getFirstSecureRecordOfType = function(result, recordType) {
        var records = getSecureRecordsOfType(result, recordType);
    ...
    hasSecureRecordOfType = function(result, recordType) {
        var record = getFirstSecureRecordOfType(result, recordType);
    ...
    areAnyRecordTypesExistant = function(recordTypesStatus) {
        var hasNonNullRecords = Object.keys(recordTypesStatus).some(function(recordTypeStatus) {
    ...
    areAllRecordTypesSecureOrNonExistant = function(recordTypesStatus) {
        var hasNonNullRecords = areAnyRecordTypesExistant(recordTypesStatus),
