var configuration = require("configvention"),
    ...
    shouldRedirectRequestToHttps = function(req) {
        ...
        // http://serverfault.com/questions/257616/requestheader-with-apache-environment-variable
        var shouldRedirect = (req.secure !== true && req.get("X-Forwarded-Proto") === "http") && configuration.get("redirect-to-https") === true;
